// ConciergeChat (#43): the reusable chat brain + UI. Used two ways:
// - embedded in the floating "Smart AI" panel on the Dashboard (Carl's
//   preferred entry point, modelled on his task app)
// - full-page at /concierge (nice on phones)
...
export default function ConciergeChat({ embedded = false }: { embedded?: boolean }) {
  ...
  return (
    <div className={embedded ? "concierge-embedded" : "concierge-full"}>
