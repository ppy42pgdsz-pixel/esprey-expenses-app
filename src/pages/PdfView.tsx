...
export default function PdfView() {
  ...
  const viewUrl = `/api/reports/view?file=${encodeURIComponent(file)}`;
  ...
  // Render whichever page is selected.
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        // Pick a scale that fills the screen width while keeping things crisp on Retina.
