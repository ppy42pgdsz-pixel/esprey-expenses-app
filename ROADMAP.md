...
- **#49 Multi-language (French first)** — IN PROGRESS 2026-07-04.
  ...
  ✅ pt-PT ADDED 2026-07-04: full UI dictionary, PDF strings, OCR notes, report translation, Concierge, all three dropdowns. Known pt gaps (fall back to English): welcome email body, FAQ content, help-widget grounding (it still *answers* in Portuguese).
